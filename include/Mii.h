...
#define WIIMOTE_MII_PARADESLOTS_OFFSET		(WIIMOTE_MII_PARADESLOTS_ADDR - WIIMOTE_MII_DATA_BEGIN_1)

#define WIIMOTE_MII_BLOCK_SIZE				(WIIMOTE_MII_SECTION_SIZE + WIIMOTE_MII_CHECKSUM_SIZE)
...
#define MII_START_OFFSET		(WIIMOTE_MII_DATA_BEGIN_1-WIIMOTE_MII_DATA_BEGIN_ADDR)
#define MII_SLOT_OFFSET(slot)	(MII_START_OFFSET + (slot * WIIMOTE_MII_DATA_BYTES_PER_SLOT))
